...
* Чрезмерная инкапсуляция:
  ...
  * Объединение в классе данных и способа их обработки

Мы выделили два вида coupling'а, причиной которых является мышление только о продакшене. Теперь мы хотим продемонстрировать, как эти виды проявляются, когда думаешь только о проде. А потом переписать этот код, используя cohesion и показав, какие преимущества мы от этого получим.