...
Billing::Event Billing::Event::Payment(int rubles) {
    return {};
}
Billing::Event Billing::Event::PhoneCall(int minutes) {
    return {};
}
bool Billing::Event::IsPayment() const {
    return false;
}
int Billing::Event::GetMoney() const {
    return 5;
}
int Billing::Event::GetDuration() const {
    return 3;
}
